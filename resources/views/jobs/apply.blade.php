...
<div class="container my-5">
    ...
    <form method="POST" action="{{ url()->current() }}" class="col-md-8" novalidate>
        @csrf
        @recaptcha
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <input type="text" name="cnic" id="cnic" class="form-control @error('cnic') is-invalid @enderror" value="{{ old('cnic') }}">
